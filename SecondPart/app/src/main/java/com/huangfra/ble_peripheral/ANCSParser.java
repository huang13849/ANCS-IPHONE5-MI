...
public class ANCSParser {
    ...
    private final static int TIMEOUT = 15 * 10000;
    ...
    private void processNotificationList() {
        ...
        if (mCurrentANCSData == null) {
            ...
            do {
                ...
                BluetoothGattCharacteristic btGattcharacteristic = mBTGattService.getCharacteristic(WatchGattConstants.WATCH_Control_point_UUID);
